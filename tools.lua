...
minetest.register_tool("geominer:pick_emerald", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[3]=0.1, [4]=0.2, [5]=0.3, [6]=0.4}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_sapphire", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[3]=0.01, [4]=0.1, [5]=0.2, [6]=0.3, [7]=0.4}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_hematite", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[3]=0.001, [4]=0.01, [5]=0.1, [6]=0.2, [7]=0.3}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
