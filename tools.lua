...
minetest.register_tool("geominer:pick_sapphire", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.15, [4]=0.2, [5]=0.25, [6]=0.3, [7]=1.5, [8]=2.0, [9]=2.5, [10]=3.0, [11]=3.5, [12]=4.0}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_hematite", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.1, [4]=0.15, [5]=0.2, [6]=0.25, [7]=0.3, [8]=1.5, [9]=2.0, [10]=2.5, [11]=3.0, [12]=3.5}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_agate", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.1, [4]=0.1, [5]=0.15, [6]=0.2, [7]=0.25, [8]=0.3, [9]=1.5, [10]=2.0, [11]=2.5, [12]=3.0}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_ruby", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.1, [4]=0.1, [5]=0.1, [6]=0.15, [7]=0.2, [8]=0.25, [9]=0.3, [10]=1.5, [11]=2.0, [12]=2.5}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_larimar", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.1, [4]=0.1, [5]=0.1, [6]=0.1, [7]=0.15, [8]=0.2, [9]=0.25, [10]=0.3, [11]=1.5, [12]=2.0}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_sunstone", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.1, [4]=0.1, [5]=0.1, [6]=0.05, [7]=0.1, [8]=0.15, [9]=0.2, [10]=0.25, [11]=0.3, [12]=1.5}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})
...
minetest.register_tool("geominer:pick_moonstone", {
	...
	tool_capabilities = {
		...
		max_drop_level = 0,
		groupcaps = {
			cracky = {times={[1]=0.1, [2]=0.1, [3]=0.1, [4]=0.1, [5]=0.1, [6]=0.1, [7]=0.1, [8]=0.1, [9]=0.15, [10]=0.2, [11]=0.25, [12]=0.3}, uses=128, maxlevel=1},
		},
		damage_groups = {fleshy=7},
	}
})